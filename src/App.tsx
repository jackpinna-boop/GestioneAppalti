...
function AdminPage({access}:{access:Access[]}){
 ...
 return <PageHead title="Amministrazione" subtitle="Configurazione del sistema, classificazione delle richieste, gestione degli accessi e tracciamento delle attività.">
   ...
   <section className="admin-section-group"><div className="card"><div className="card-head"><div><h2>Microsoft / Azure</h2><p>Provider OAuth configurabile in Supabase Auth.</p></div><ShieldCheck size={20}/></div><code>https://cuaxulqyrhosqbfaympv.supabase.co/auth/v1/callback</code></section>
 </PageHead>
}
